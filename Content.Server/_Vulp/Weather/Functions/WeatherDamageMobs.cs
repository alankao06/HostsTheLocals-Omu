...
using Content.Shared._Shitmed.Damage; //Added this cus of changes to TryGetDamage
    ...
    public override void Invoke(EntityManager entMan, Entity<WeatherComponent> ent, float updateTimeSeconds)
    {
        ...
        while (query.MoveNext(out var uid, out var mobState, out var damageable, out var xform))
        {
            ...
            damageSystem.TryChangeDamage(
                ...
                1f,
                null,
                false, //i frankly have no clue what this does and im too tired to check rn
                SplitDamageBehavior.Split,
                true); // TODO: what is a good value for partMultiplier?
        }
    }
}
